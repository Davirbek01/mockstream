  ...
  async function renderSubscription(list) {
    ...
    list.innerHTML =
      '<div class="bbA-subform">' +
        ...
        '<div class="bbA-field"><label>Admin name <span style="color:#94a3b8;font-weight:600;">(optional — shown as "Admin" in the modal)</span></label><input id="fs_instr" type="text" value="' + _attr(row.instructor) + '" placeholder="Dilshodbek Abdullajonov" /></div>' +
