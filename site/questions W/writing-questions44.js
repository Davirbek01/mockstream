...
window.WRITING_TEST_DATA = {
  ...
  "tasks": {
    "p1_context": "You recently used a food delivery app for the first time.",
    "p1_scenario": "Dear Valued Customer,\n\nThank you for trying QuickBite Food Delivery! We hope your first order exceeded expectations.\nHow was the delivery speed and food quality upon arrival? Was our app easy to use?\nWhat would make you a regular customer?\n\nQuickBite Support Team",
    "t11": {
      "title": "Task 1.1",
      "target": "50 words",
      "prompt": "Write a letter to your friend, who hasn't tried food delivery apps. Write about your feelings and what you think they should do.",
      "sample": "Hey!\n\nYou <span class=\"ml-token modal\">have to</span> try QuickBite! I <span class=\"ml-token adv\">just</span> ordered dinner and it arrived in 20 minutes! The <span class=\"ml-token colloc\">app</span> is <span class=\"ml-token adv\">super</span> easy to use and there are <span class=\"ml-token adv\">tons</span> of <span class=\"ml-token colloc\">restaurants</span> to choose from.\n\nSo convenient when you're too tired to cook!",
    ...
    "t12": {
      ...
      "prompt": "Write a letter to the food delivery service. Write about your feelings and what you think they should do.",
      "sample": "<p>Dear QuickBite Support Team,</p>\n\n<p>Thank you for reaching out. I am pleased to share my feedback on my first order.</p>\n\n<p><span class=\"ml-token adv\">Firstly</span>, the <span class=\"ml-token colloc\">delivery speed</span> was <span class=\"ml-token colloc\">impressive</span>. My food arrived well within the <span class=\"ml-token colloc\">estimated time</span> and was still hot.</p>\n\n<p><span class=\"ml-token adv\">However</span>, I noticed the <span class=\"ml-token colloc\">packaging</span> was <span class=\"ml-token adv\">somewhat</span> flimsy, causing minor spillage. Using <span class=\"ml-token colloc\">sturdier containers</span> <span class=\"ml-token modal\">would</span> prevent this issue.</p>\n\n<p><span class=\"ml-token adv\">Additionally</span>, the <span class=\"ml-token colloc\">delivery fee</span> seemed high for short distances. Introducing <span class=\"ml-token colloc\">tiered pricing</span> based on distance <span class=\"ml-token modal\">would</span> be fairer.</p>\n\n<p><span class=\"ml-token adv\">Furthermore</span>, offering a <span class=\"ml-token colloc\">loyalty program</span> with rewards for frequent orders <span class=\"ml-token modal\">would</span> <span class=\"ml-token adv\">certainly</span> encourage <span class=\"ml-token colloc\">repeat business</span>.</p>\n\n<p>The <span class=\"ml-token colloc\">real-time tracking</span> feature was excellent and <span class=\"ml-token adv\">greatly</span> appreciated.</p>\n\n<p>Kind regards,<br>A New Customer</p>",
    ...
    "t2": {
      ...
      "prompt": "You are participating in an online discussion forum. The topic is: \"Should homework be abolished in schools?\" Write your response, giving reasons and examples. Write 180–200 words.",
      "sample": "<h2>Food Delivery: Convenience or Laziness?</h2>\n\n<p><span class=\"ml-token colloc\">Food delivery apps</span> have <span class=\"ml-token adv\">revolutionized</span> how we eat. But critics argue they're making us lazy. Let me share my perspective.</p>\n\n<p><span class=\"ml-token adv\">Honestly</span>, I think it depends on how you use them. For busy professionals working long hours, delivery apps provide <span class=\"ml-token colloc\">valuable time savings</span>. That's <span class=\"ml-token colloc\">efficiency</span>, not laziness.</p>\n\n<p><span class=\"ml-token adv\">Moreover</span>, these apps support local restaurants and create <span class=\"ml-token colloc\">employment opportunities</span> for delivery drivers. They're a <span class=\"ml-token colloc\">legitimate service</span> meeting real needs.</p>\n\n<p><span class=\"ml-token adv\">However</span>, there are valid concerns. Relying <span class=\"ml-token adv\">exclusively</span> on delivery <span class=\"ml-token modal\">can</span> be expensive, less healthy, and <span class=\"ml-token modal\">may</span> reduce our <span class=\"ml-token colloc\">cooking skills</span>.</p>\n\n<p><span class=\"ml-token adv\">Additionally</span>, the <span class=\"ml-token colloc\">environmental impact</span> of countless delivery vehicles and <span class=\"ml-token colloc\">single-use packaging</span> is concerning.</p>\n\n<p><span class=\"ml-token adv\">Ultimately</span>, moderation is key. Using delivery apps <span class=\"ml-token adv\">occasionally</span> when genuinely needed makes sense. But replacing all home cooking? That's where convenience becomes <span class=\"ml-token colloc\">problematic</span>.</p>\n\n<p>What's your relationship with food delivery apps?</p>",
  ...
  "vocabulary": {
    "task11": [
      ...
      {
        "en": "tons of restaurants",
        "uz": "juda ko'p restoranlar"
      },
      {
        "en": "choose from",
        "uz": "tanlamoq"
      ...
      {
        "en": "game changer",
        "uz": "hayotni o'zgartiruvchi"
      },
      {
        "en": "no hassle",
        "uz": "hech qanday muammo yo'q"
      },
      {
        "en": "totally worth it",
        "uz": "to'liq arziydi"
      ...
      },
      {
        ...
        "uz": "birinchi buyurtma chegirmasi"
      },
      {
        "en": "use promo code",
        "uz": "promo kodni ishlating"
      }
    ],
    "task12": [
      {
      ...
      {
        "en": "frequent orders",
        "uz": "tez-tez buyurtmalar"
      },
      {
        "en": "prevent issue",
        "uz": "muammoni oldini olmoq"
      }
    ],
    "task2": [
      {
        "en": "food delivery apps",
        "uz": "ovqat yetkazib berish ilovalari"
      },
      {
        "en": "revolutionized",
        "uz": "inqilob qildi"
      ...
      {
        "en": "valuable time savings",
        "uz": "qimmatli vaqtni tejash"
      },
      {
        "en": "efficiency",
        "uz": "samaradorlik"
      ...
      {
        "en": "legitimate service",
        "uz": "qonuniy xizmat"
      },
      {
        "en": "cooking skills",
        "uz": "oshpazlik ko'nikmalari"
      },
      {
        "en": "environmental impact",
        "uz": "atrof-muhitga ta'sir"
      },
      {
      ...
      {
        "en": "moderation is key",
        "uz": "me'yoriylik muhim"
      },
      {
        "en": "problematic",
        "uz": "muammoli"
      ...
      {
        "en": "relying exclusively",
        "uz": "faqat tayanish"
      },
      {
        "en": "valid concerns",
        "uz": "asosli tashvishlar"
      },
      {
        "en": "support local restaurants",
        "uz": "mahalliy restoranlarni qo'llab-quvvatlash"
      },
      {
        "en": "convenience",
        "uz": "qulaylik"
