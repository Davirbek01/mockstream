...
window.WRITING_TEST_DATA = {
  ...
  "tasks": {
    "p1_context": "You recently started using a meal kit delivery service.",
    "p1_scenario": "Dear Customer,\n\nThank you for trying FreshBox Meal Kits! We hope you've enjoyed cooking delicious meals at home.\nHow did you find our recipes and ingredient quality? Were the portions and packaging satisfactory?\nWhat cuisines or dietary options would you like us to add to our menu?\n\nFreshBox Team",
    "t11": {
      "title": "Task 1.1",
      "target": "50–70 words",
      "prompt": "Write a letter to your friend, who wants to cook more but is always too busy to shop. Write about your feelings and what you think they should do.",
      "sample": "Hey!\n\nI know you want to cook more but hate grocery shopping. I've been using FreshBox <span class=\"ml-token colloc\">meal kits</span> and it's been <span class=\"ml-token adv\">absolutely</span> amazing! All the ingredients come <span class=\"ml-token colloc\">pre-measured</span> with easy recipes. I'm cooking <span class=\"ml-token adv\">so</span> much better now! You <span class=\"ml-token modal\">should</span> <span class=\"ml-token adv\">definitely</span> try it!\n\n<span class=\"ml-token phrasal\">Take care</span>!",
    ...
    "t12": {
      ...
      "prompt": "Write a letter to the meal kit service. Write about your feelings and what you think they should do.",
      "sample": "Dear FreshBox Team,\n\nThank you for asking about my experience with your <span class=\"ml-token colloc\">meal kit service</span>.\n\nI am <span class=\"ml-token adv\">thoroughly</span> impressed with the quality. The <span class=\"ml-token colloc\">fresh ingredients</span> always arrive in perfect condition. The <span class=\"ml-token colloc\">recipe cards</span> are clear and easy to follow, even for a beginner. I've <span class=\"ml-token adv\">genuinely</span> improved my cooking skills.\n\n<span class=\"ml-token adv\">However</span>, I have some suggestions. Some recipes require <span class=\"ml-token adv\">rather</span> long preparation times, which isn't ideal for weeknight dinners. <span class=\"ml-token adv\">Additionally</span>, the <span class=\"ml-token colloc\">plastic packaging</span> seems excessive.\n\nI <span class=\"ml-token modal\">would</span> appreciate more <span class=\"ml-token colloc\">quick meals</span> under 30 minutes. <span class=\"ml-token colloc\">Vegetarian options</span> and <span class=\"ml-token colloc\">low-carb meals</span> <span class=\"ml-token modal\">would</span> cater to different dietary needs. <span class=\"ml-token adv\">Also</span>, using <span class=\"ml-token colloc\">sustainable packaging</span> <span class=\"ml-token modal\">would</span> reduce environmental impact.\n\n<span class=\"ml-token adv\">Overall</span>, FreshBox has made home cooking enjoyable and convenient.\n\nYours sincerely,\n[Your name]",
    ...
    "t2": {
      ...
      "prompt": "A student magazine announced an article writing contest. The best ones will be published in the magazine. Write your article on this topic: \"Is cooking at home healthier than eating out?\" Write 180–200 words, giving reasons and examples.",
      "sample": "<p>With busy lifestyles, many people rely on restaurants and <span class=\"ml-token colloc\">takeaway food</span>. <span class=\"ml-token adv\">However</span>, I <span class=\"ml-token adv\">firmly</span> believe <span class=\"ml-token colloc\">home cooking</span> is healthier.</p>\n\n<p><span class=\"ml-token adv\">Firstly</span>, cooking at home gives complete <span class=\"ml-token colloc\">control over ingredients</span>. You can choose fresh vegetables, limit salt and sugar, and avoid <span class=\"ml-token colloc\">unhealthy additives</span>. Restaurant meals often contain hidden fats and excessive sodium.</p>\n\n<p><span class=\"ml-token adv\">Secondly</span>, <span class=\"ml-token colloc\">portion control</span> is easier at home. Restaurants serve large portions to provide value, encouraging <span class=\"ml-token colloc\">overeating</span>. At home, you can prepare appropriate amounts, helping maintain a <span class=\"ml-token colloc\">healthy weight</span>.</p>\n\n<p><span class=\"ml-token adv\">However</span>, eating out has benefits. It saves time, offers variety, and provides <span class=\"ml-token colloc\">social experiences</span>. <span class=\"ml-token adv\">Additionally</span>, some restaurants focus on <span class=\"ml-token colloc\">healthy menus</span> with nutritional information.</p>\n\n<p><span class=\"ml-token adv\">Nevertheless</span>, research <span class=\"ml-token adv\">consistently</span> shows people who cook at home have better <span class=\"ml-token colloc\">nutritional intake</span>. They consume more <span class=\"ml-token colloc\">fruits and vegetables</span> and fewer calories overall.</p>\n\n<p><span class=\"ml-token adv\">In conclusion</span>, while <span class=\"ml-token colloc\">occasional dining out</span> is enjoyable, <span class=\"ml-token colloc\">regular home cooking</span> <span class=\"ml-token modal\">should</span> be prioritized for better health. Even simple meals prepared at home are <span class=\"ml-token adv\">typically</span> more nutritious than restaurant food.</p>",
  ...
  "vocabulary": {
    "task11": [
      ...
      {
        "en": "pre-measured ingredients",
        "uz": "oldindan o'lchangan ingredientlar"
      },
      {
        "en": "easy recipes",
        "uz": "oson retseptlar"
      ...
      {
        "en": "weekly delivery",
        "uz": "haftalik yetkazib berish"
      },
      {
        "en": "step-by-step instructions",
        "uz": "bosqichma-bosqich ko'rsatmalar"
      },
      {
        "en": "healthy eating",
    ...
    "task12": [
      ...
      },
      {
        ...
        "uz": "vegetarian variantlar"
      },
      {
        "en": "low-carb meals",
        "uz": "kam uglevodli ovqatlar"
      },
      {
        "en": "sustainable packaging",
        "uz": "barqaror qadoqlash"
      },
      {
        "en": "thoroughly impressed",
        "uz": "to'liq hayratda qoldim"
      },
      {
      ...
      {
        "en": "genuinely improved",
        "uz": "haqiqatan yaxshilandi"
      },
      {
        "en": "cooking skills",
        "uz": "pishirish qobiliyatlari"
      },
      {
        "en": "preparation times",
        "uz": "tayyorlash vaqti"
      },
      {
        "en": "weeknight dinners",
        "uz": "hafta ichi kechki ovqatlar"
      },
      {
        "en": "seems excessive",
        "uz": "haddan tashqari ko'rinadi"
      },
      {
        "en": "dietary needs",
        "uz": "parhez ehtiyojlari"
      },
      {
    ...
    "task2": [
      ...
      {
        "en": "control over ingredients",
        "uz": "ingredientlar ustidan nazorat"
      },
      {
        "en": "unhealthy additives",
        "uz": "sog'liqsiz qo'shimchalar"
      },
      {
        "en": "portion control",
        "uz": "ulush nazorati"
      ...
      {
        "en": "occasional dining out",
        "uz": "vaqti-vaqti bilan tashqarida ovqatlanish"
      },
      {
        "en": "regular home cooking",
        "uz": "muntazam uyda pishirish"
      },
      {
        "en": "fresh vegetables",
      ...
      {
        "en": "appropriate amounts",
        "uz": "tegishli miqdorlar"
      },
      {
        "en": "in conclusion",
