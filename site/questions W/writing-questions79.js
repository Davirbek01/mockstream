...
window.WRITING_TEST_DATA = {
  ...
  "tasks": {
    "p1_context": "You recently started using a new coworking space in your city.",
    "p1_scenario": "Dear Member,\n\nThank you for choosing HubSpace Coworking! We hope our facilities are helping you work productively.\nHow do you find the workspace environment and our amenities? Is the location convenient for you?\nWhat additional services or improvements would enhance your experience here?\n\nHubSpace Team",
    "t11": {
      "title": "Task 1.1",
      "target": "50–70 words",
      "prompt": "Write a letter to your friend, who works from home and feels isolated. Write about your feelings and what you think they should do.",
      "sample": "Hey!\n\nI know working from home can feel lonely. I <span class=\"ml-token adv\">recently</span> joined HubSpace <span class=\"ml-token colloc\">coworking space</span> and it's been <span class=\"ml-token adv\">amazing</span>! The <span class=\"ml-token colloc\">atmosphere</span> is <span class=\"ml-token adv\">so</span> motivating and I've met some <span class=\"ml-token adv\">really</span> interesting people. You <span class=\"ml-token modal\">should</span> <span class=\"ml-token adv\">definitely</span> check it out – it <span class=\"ml-token modal\">might</span> be <span class=\"ml-token adv\">exactly</span> what you need!\n\n<span class=\"ml-token phrasal\">Take care</span>!",
    ...
    "t12": {
      ...
      "prompt": "Write a letter to the coworking space. Write about your feelings and what you think they should do.",
      "sample": "Dear HubSpace Team,\n\nThank you for asking about my experience at your <span class=\"ml-token colloc\">coworking space</span>.\n\nI am <span class=\"ml-token adv\">thoroughly</span> enjoying the <span class=\"ml-token colloc\">workspace environment</span>. The <span class=\"ml-token colloc\">open-plan design</span> is <span class=\"ml-token adv\">wonderfully</span> bright, and the high-speed WiFi is <span class=\"ml-token adv\">extremely</span> reliable. The central location makes <span class=\"ml-token colloc\">commuting</span> very convenient.\n\n<span class=\"ml-token adv\">However</span>, there are some areas for improvement. The <span class=\"ml-token colloc\">meeting rooms</span> are often fully booked, making last-minute bookings <span class=\"ml-token adv\">rather</span> difficult. <span class=\"ml-token adv\">Additionally</span>, the <span class=\"ml-token colloc\">phone booths</span> for private calls are <span class=\"ml-token adv\">quite</span> limited.\n\nI <span class=\"ml-token modal\">would</span> suggest adding more <span class=\"ml-token colloc\">quiet zones</span> for focused work. A <span class=\"ml-token colloc\">networking events</span> calendar <span class=\"ml-token modal\">would</span> help members connect professionally. <span class=\"ml-token adv\">Also</span>, extended <span class=\"ml-token colloc\">weekend hours</span> <span class=\"ml-token modal\">would</span> benefit those with flexible schedules.\n\n<span class=\"ml-token adv\">Overall</span>, HubSpace has <span class=\"ml-token adv\">significantly</span> improved my <span class=\"ml-token colloc\">work-life balance</span>.\n\nYours sincerely,\n[Your name]",
    ...
    "t2": {
      ...
      "prompt": "You are participating in an online discussion forum. The topic is: \"Should governments spend more on space exploration?\" Write your response, giving reasons and examples. Write 180–200 words.",
      "sample": "<p><span class=\"ml-token colloc\">Space exploration</span> represents humanity's greatest scientific ambition. <span class=\"ml-token adv\">However</span>, I believe governments <span class=\"ml-token modal\">should</span> balance this spending with <span class=\"ml-token colloc\">earthly priorities</span>.</p>\n\n<p><span class=\"ml-token adv\">Firstly</span>, space research has produced remarkable <span class=\"ml-token colloc\">technological innovations</span>. GPS, weather satellites, and medical advances all originated from <span class=\"ml-token colloc\">space programs</span>. These <span class=\"ml-token colloc\">spin-off technologies</span> benefit everyday life in countless ways.</p>\n\n<p><span class=\"ml-token adv\">Secondly</span>, exploring space addresses <span class=\"ml-token colloc\">long-term survival</span>. Understanding asteroids, finding new resources, and <span class=\"ml-token adv\">potentially</span> colonizing other planets could be essential for humanity's future.</p>\n\n<p><span class=\"ml-token adv\">However</span>, critics <span class=\"ml-token adv\">rightly</span> point out that billions spent on rockets <span class=\"ml-token modal\">could</span> address <span class=\"ml-token colloc\">poverty, hunger, and disease</span>. When people lack basic necessities, spending on distant planets <span class=\"ml-token modal\">may</span> seem irresponsible.</p>\n\n<p><span class=\"ml-token adv\">Nevertheless</span>, the investment is <span class=\"ml-token adv\">relatively</span> small compared to military budgets. NASA receives less than 1% of US federal spending. <span class=\"ml-token adv\">Moreover</span>, <span class=\"ml-token colloc\">private companies</span> are now sharing costs.</p>\n\n<p><span class=\"ml-token adv\">In conclusion</span>, <span class=\"ml-token colloc\">space exploration</span> <span class=\"ml-token modal\">should</span> continue with moderate government investment, while private sector partnerships help reduce taxpayer burden. Exploring the cosmos defines our species' curiosity and ambition.</p>",
  ...
  "vocabulary": {
    "task11": [
      {
        "en": "coworking space",
        "uz": "hamkorlik ish joyi"
      },
      {
        "en": "feel lonely",
        "uz": "yolg'iz his qilmoq"
      },
      {
        "en": "amazing atmosphere",
        "uz": "ajoyib muhit"
      },
      {
        "en": "so motivating",
        "uz": "juda rag'batlantiruvchi"
      },
      {
        "en": "interesting people",
        "uz": "qiziqarli odamlar"
      },
      {
        "en": "definitely check out",
        "uz": "albatta ko'ring"
      },
      {
        "en": "exactly what you need",
        "uz": "aynan sizga kerak narsa"
      },
      {
        "en": "take care",
      ...
      {
        "en": "feel isolated",
        "uz": "ajralib qolganday his qilmoq"
      },
      {
        "en": "productive environment",
        "uz": "samarali muhit"
      },
      {
        "en": "meet people",
        "uz": "odamlar bilan tanishish"
      },
      {
        "en": "highly recommend",
      ...
      {
        "en": "professional setting",
        "uz": "professional muhit"
      },
      {
        "en": "flexible hours",
        "uz": "moslashuvchan soatlar"
      },
      {
        "en": "networking opportunity",
        "uz": "tarmoq imkoniyati"
      },
      {
        "en": "creative atmosphere",
        "uz": "ijodiy muhit"
      },
      {
        "en": "let me know",
    ...
    "task12": [
      ...
      {
        "en": "workspace environment",
        "uz": "ish joyi muhiti"
      },
      {
        "en": "open-plan design",
        "uz": "ochiq rejali dizayn"
      },
      {
        "en": "meeting rooms",
        "uz": "yig'ilish xonalari"
      },
      {
        "en": "phone booths",
      ...
      },
      {
        ...
        "uz": "ish-hayot muvozanati"
      },
      {
        "en": "thoroughly enjoying",
        "uz": "to'liq zavqlanmoqdaman"
      },
      {
        "en": "wonderfully bright",
        "uz": "ajoyib yorqin"
      },
      {
        "en": "extremely reliable",
        "uz": "juda ishonchli"
      },
      {
        "en": "central location",
      ...
      {
        "en": "commuting convenient",
        "uz": "yetib borish qulay"
      },
      {
        "en": "fully booked",
        "uz": "to'liq band"
      ...
      {
        "en": "last-minute bookings",
        "uz": "oxirgi daqiqada band qilish"
      },
      {
        "en": "quite limited",
        "uz": "ancha cheklangan"
      ...
      {
        "en": "significantly improved",
        "uz": "sezilarli darajada yaxshilandi"
      }
    ],
    "task2": [
      {
        "en": "space exploration",
        "uz": "kosmosni o'rganish"
      },
      {
        "en": "earthly priorities",
        "uz": "er ustidagi ustuvorliklar"
      },
      {
        "en": "technological innovations",
        "uz": "texnologik innovatsiyalar"
      },
      {
        "en": "space programs",
        "uz": "kosmik dasturlar"
      ...
      {
        "en": "scientific ambition",
        "uz": "ilmiy ambitsiya"
      },
      {
        "en": "weather satellites",
        "uz": "ob-havo sun'iy yo'ldoshlari"
      },
      {
        "en": "medical advances",
        "uz": "tibbiy yutuqlar"
      ...
      {
        "en": "colonizing planets",
        "uz": "sayyoralarni mustamlaka qilish"
      },
      {
        "en": "military budgets",
        "uz": "harbiy byudjetlar"
      },
      {
        "en": "federal spending",
        "uz": "federal xarajatlar"
      },
      {
        "en": "taxpayer burden",
        "uz": "soliq to'lovchilarga yuk"
      },
      {
        "en": "moderate investment",
        "uz": "mo''tadil investitsiya"
      },
      {
        "en": "human curiosity",
        "uz": "inson qiziquvchanligi"
      },
      {
        "en": "in conclusion",
