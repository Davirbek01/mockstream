...
p1_sections = [
    {
        ...
        "title": "Questions 1-5",
        "instruction": "Questions 1-5<br><br>Complete the summary below.<br><br>Write <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.",
        "headingsList": [],
        "featuresList": [],
        "questions": [
            {"id": 1, "text": "Studies at Yale University have shown that a positive attitude can lengthen someone's lifespan by approximately {INPUT}."},
            {"id": 2, "text": "Another research team claims to have found a physical reason why this happens. As a result of an eight-year study on {INPUT} male subjects of a certain age, they have noted differences in"},
            {"id": 3, "text": "{INPUT} among positive and negative thinkers."},
            {"id": 4, "text": "This discovery has led some early research on {INPUT}."},
            {"id": 5, "text": "Rosana Wright cites {INPUT} in support of this view."}
        ]
    },
    {
        ...
        "instruction": "Questions 6-10<br><br>Complete each sentence with the correct ending, <strong>A-H</strong>, below.",
        "headingsList": [],
        "featuresList": [
            ...
            "F happiness is not linked to material comfort.",
            "G levels of optimism can decrease with age.",
            "H optimists can have a positive effect on pessimists."
        ],
        "questions": [
            {"id": 6, "text": "The writer's reference to Sigmund Freud illustrates the point that:"},
            {"id": 7, "text": "According to Brice Pitt of Imperial College, London,"},
            {"id": 8, "text": "Researchers at the Henley Centre have shown that:"},
            {"id": 9, "text": "The 1995 Adweek Survey found that across the USA:"},
            {"id": 10, "text": "The psychotherapist Lynn Myers suggests that:"}
        ]
    },
    {
        "type": "ynng",
        ...
        "instruction": "Questions 11-13<br><br>Choose <strong>Yes</strong> if the statement agrees with the claims of the writer, choose <strong>No</strong> if the statement contradicts the claims of the writer, or choose <strong>Not Given</strong> if there is no information on this.",
        "headingsList": [],
        "featuresList": [],
        "questions": [
            {"id": 11, "text": "It has been known for some time that there is a link between optimism and good health."},
            {"id": 12, "text": "Optimists have better personal relationships with others than pessimists."},
            {"id": 13, "text": "People who live to be over ninety-five are known to take the same amount of regular exercise."}
        ]
    }
]
...
p2_sections = [
    {
        ...
        "instruction": "Questions 14-17<br><br>Complete the summary below.<br><br>Write <strong>ONE WORD ONLY</strong> from the passage for each answer.",
        "headingsList": [],
        "featuresList": [],
        "questions": [
            {"id": 14, "text": "<strong>Insomnia in the USA</strong><br>Last year the high number of {INPUT} highlighted the fact that insomnia is a serious issue in the USA."},
            {"id": 15, "text": "It is evidently responsible for a number of serious traffic {INPUT} and has a considerable effect on company"},
            {"id": 16, "text": "{INPUT}, although there are no statistics on this."},
            {"id": 17, "text": "Unfortunately, there is insufficient official funding given to research into sleep problems, and the {INPUT} given at medical school is also insufficient to deal with insomnia."}
        ]
    },
    {
        "type": "matching-info",
        ...
        "instruction": "Questions 18-23<br><br>Reading Passage 2 has nine paragraphs, <strong>A-I</strong>.<br><br>Which paragraph contains the following information?<br><br>Choose the correct letter, <strong>A-I</strong>, in boxes 18-23.",
        "headingsList": [],
        "featuresList": ["A","B","C","D","E","F","G","H","I"],
        "questions": [
            {"id": 18, "text": "a mention of different cultural approaches to dealing with insomnia"},
            {"id": 19, "text": "indications that sleep has a positive effect on health"},
            {"id": 20, "text": "the effects of different kinds of sleep on mental performance"},
            {"id": 21, "text": "reasons why various species of animal sleep in different ways"},
            {"id": 22, "text": "the suggestion that sleep allows us to get rid of insignificant information"},
            {"id": 23, "text": "a description of how the brain responds when a person stops breathing"}
        ]
    },
    {
        ...
        "instruction": "Questions 24-26<br><br>Look at the following statements (Questions 24-26) and the list of people below.<br><br>Match each statement with the correct person, <strong>A-E</strong>.<br><br>Choose the correct letter, <strong>A-E</strong>, in boxes 24-26.",
        ...
        "questions": [
            {"id": 24, "text": "Research tells us that we sleep as reaction to our body's signals."},
            {"id": 25, "text": "People suffering from insomnia are easily recognisable."},
            {"id": 26, "text": "Therapy does not always enable people to achieve good quality sleep."}
        ]
    }
]
...
p3_sections = [
    {
        ...
        "instruction": "Questions 27-31<br><br>Choose the correct answer.",
        "headingsList": [],
        "featuresList": [],
        "questions": [
            {"id": 27, "text": "What does the writer suggest about game theory software in the first paragraph?", "options": ["Traditional negotiation practices should be used to supplement the software.", "Success of the software depends on the accuracy of the assigned values.", "This software anticipates the outcome of future events.", "Future business negotiations will be dominated by this software."]},
            {"id": 28, "text": "Reinier van Oosten says predicting what people will do works best if", "options": ["participants are honest about how they feel.", "there is a good understanding of the client's culture.", "people strongly dislike the other party.", "profit is the primary motivator."]},
            {"id": 29, "text": "After using game theory software in 2006, Dr Milgrom instructed his clients to", "options": ["buy big licenses.", "negotiate with the other parties directly.", "make one big offer at the end of the auction.", "purchase a mix of licenses."]},
            {"id": 30, "text": "The writer refers to Stephen Black's ice-cream seller example in order to", "options": ["show the impact new competitors have on business.", "highlight the importance of location on business success.", "demonstrate that businesses must follow a strategy.", "clarify how pricing affects sales."]},
            {"id": 31, "text": "Ponsati believes business negotiations are more likely to progress if", "options": ["a solution is proposed by one of the interested parties.", "mediators or computers take over the bargaining process.", "both parties follow the rules of negotiating.", "sufficient time is allowed for the bargaining process."]}
        ]
    },
    {
        "type": "ynng",
        ...
        "instruction": "Questions 32-35<br><br>Choose <strong>Yes</strong> if the statement agrees with the claims of the writer, choose <strong>No</strong> if the statement contradicts the claims of the writer, or <strong>Not Given</strong> if it is impossible to say what the writer thinks about this.",
        "headingsList": [],
        "featuresList": [],
        "questions": [
            {"id": 32, "text": "Game theory software may be unhelpful when dealing with political issues."},
            {"id": 33, "text": "Dr Milgrom was confident about applying his software to an auction in 2006."},
            {"id": 34, "text": "Dr Ponsati believes 'mediation machines' are an inappropriate method of negotiation in areas other than business."},
            {"id": 35, "text": "Military organizations refuse to accept that software based on game theory could prevent wars."}
        ]
    },
    {
        "type": "matching-sentence-endings",
        ...
        "instruction": "Questions 36-40<br><br>Complete each sentence with the correct ending, <strong>A-F</strong>, below.",
        "headingsList": [],
        "featuresList": [
        ...
        "questions": [
            {"id": 36, "text": "According to Reinier van Oosten, game theory software fails when"},
            {"id": 37, "text": "Dr Milgrom's software is successful in detecting if"},
            {"id": 38, "text": "Dr Black's game theory software is a helpful tool when"},
            {"id": 39, "text": "Dr Ponsati's mediation machine is useful when"},
            {"id": 40, "text": "According to Dr Ponsati, without mediation machines, negotiations may fail when"}
        ]
    }
]
...
js = "// IELTS Reading Test 44 - Generated 04/02/2026\n" \
     "// Passage 1: Optimism and Health | Passage 2: Why don't we sleep? | Passage 3: Game Theory\n\n" \
     "window.IELTS_READING_TEST = " + json.dumps(final_data, ensure_ascii=False, indent=4) + ";\n"

out = r"questions IELTS R\ielts-reading-test-44.js"
