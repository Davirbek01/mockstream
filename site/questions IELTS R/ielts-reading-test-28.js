            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        { "id": 1, "text": "{INPUT} to direct the tunnelling" },
                        { "id": 2, "text": "water runs into a {INPUT} used by local people" },
                        { "id": 3, "text": "vertical shafts to remove earth and for {INPUT}" },
                        { "id": 4, "text": "{INPUT} made of wood or stone" },
                        { "id": 5, "text": "{INPUT} attached to the plumb line" },
                        { "id": 6, "text": "handholds and footholds used for {INPUT}" }
                    ]
                },
                {
                    "type": "tfng",
                    ...
                    "questions": [
                        { "id": 7, "text": "The counter-excavation method completely replaced the qanat method in the 6th century BCE." },
                        { "id": 8, "text": "Only experienced builders were employed to construct a tunnel using the counter-excavation method." },
                        { "id": 9, "text": "The information about a problem that occurred during the construction of the Saldae aqueduct system was found in an ancient book." },
                        { "id": 10, "text": "The mistake made by the builders of the Saldae aqueduct system was that the two parts of the tunnel failed to meet." }
                    ]
                },
                {
                    "type": "completion",
                    ...
                    "questions": [
                        { "id": 11, "text": "What type of mineral were the Dolaucothi mines in Wales built to extract? {INPUT}" },
                        { "id": 12, "text": "In addition to the patron, whose name might be carved onto a tunnel? {INPUT}" },
                        { "id": 13, "text": "What part of Seleuceia Pieria was the Cevlik tunnel built to protect? {INPUT}" }
                    ]
                }
            ],
            "correctAnswers": {
                ...
                "q10": ["TRUE"],
                "q11": ["GOLD"],
                "q12": ["ARCHITECT", "ARCHITECT'S NAME", "THE ARCHITECT", "THE ARCHITECT'S NAME"],
                "q13": ["HARBOUR", "HARBOR", "THE HARBOUR", "THE HARBOR"]
            },
            "explanations": {
                "q1": "Persian qanat construction used posts in a straight line to keep direction.",
                "q2": "Completed tunnels directed water toward a canal for human use.",
                "q3": "The shafts were used for both removing excavated soil and ventilation.",
                "q4": "Roman shafts were covered with a wooden or stone lid.",
                "q5": "A plumb line with a weight was used to check vertical alignment.",
                "q6": "Handholds and footholds helped people climbing in and out.",
                "q7": "Counter-excavation appeared as a second method; qanat continued to be used.",
                "q8": "No statement is made about builder experience requirements.",
                "q9": "The Saldae issue is described in an inscription on a tunnel side, not a book.",
                "q10": "The inscription says the two teams missed each other initially.",
                "q11": "Dolaucothi mines were used to mine gold.",
                "q12": "Inscriptions sometimes included the name of the architect.",
                "q13": "Cevlik tunnel diverted floodwater threatening the harbor."
            }
        },
        {
            "id": 2,
...
<p>There's an old rule in neuroscience that does not alter with age: use it or lose it. It is a very hopeful principle when applied to critical thought in the reading brain because it implies choice. The story of the changing reading brain is hardly finished. We possess both the science and the technology to identify and redress the changes in how we read before they become entrenched. If we work to understand exactly what we lose, alongside the extraordinary new capacities that the digital world has brought us, there is as much reason for excitement as caution.</p>`,
            "questionSections": [
                ...
                },
                {
                    ...
                    "questions": [
                        { "id": 18, "text": "There have been many studies on digital screen use, showing some {INPUT} trends." },
                        { "id": 19, "text": "Her team then used a question-and-answer technique to find out how {INPUT} each group’s understanding of the plot was." },
                        { "id": 20, "text": "those who read screens finding the order of information {INPUT} to recall." },
                        { "id": 21, "text": "students are tending to read {INPUT} words and phrases in a text to save time." },
                        { "id": 22, "text": "This approach ... gives the reader a superficial understanding of the {INPUT} content of material" }
                    ]
                },
                {
                    "type": "ynng",
                    ...
                    "questions": [
                        { "id": 23, "text": "The medium we use to read can affect our choice of reading content." },
                        { "id": 24, "text": "Some age groups are more likely to lose their complex reading skills than others." },
                        { "id": 25, "text": "False information has become more widespread in today’s digital era." },
                        { "id": 26, "text": "We still have opportunities to rectify the problems that technology is presenting." }
                    ]
                }
            ],
            "correctAnswers": {
            ...
            "explanations": {
                "q14": "The paragraph's focus is an unseen neural change linked to technology use.",
                "q15": "Turkle says the problem is ignoring what is diminished while innovating.",
                "q16": "The writer explains the reading circuit adapts to environmental/medium demands.",
                "q17": "Edmundson says students now avoid dense classics and choose simpler texts.",
                "q18": "The studies are described as showing troubling or worrying downstream effects.",
                "q19": "Mangen's questions tested depth/thoroughness of plot comprehension.",
                "q20": "Screen readers were weaker at sequencing details, making order harder to recall.",
                "q21": "Liu describes skimming as sampling and word-spotting isolated words/phrases.",
                "q22": "Skimming leaves little time to understand others' feelings (emotional content).",
                "q23": "The writer says medium changes not only how we read but also what we read.",
                "q24": "The text states this is not only about the young and affects us all.",
                "q25": "The writer says people become susceptible to false information and irrational ideas.",
                "q26": "Final paragraph says we can identify and redress changes before they are entrenched."
            }
        },
        {
            "id": 3,
...
<p>We don't need to understand the intricate inner workings of AI systems, but if people are given a degree of responsibility for how they are implemented, they will be more willing to accept AI into their lives.</p>`,
            "questionSections": [
                ...
                },
                {
                    ...
                    "questions": [
                        { "id": 36, "text": "Subjective depictions of AI in sci-fi films make people change their opinions about automation." },
                        { "id": 37, "text": "Portrayals of AI in media and entertainment are likely to become more positive." },
                        { "id": 38, "text": "Rejection of the possibilities of AI may have a negative effect on many people's lives." },
                        { "id": 39, "text": "Familiarity with AI has very little impact on people's attitudes to the technology." },
                        { "id": 40, "text": "AI applications which users are able to modify are more likely to gain consumer approval." }
                    ]
                }
            ],
            "correctAnswers": {
            ...
            "explanations": {
                "q27": "Section A emphasizes that AI forecasts are often superior to humans'.",
                "q28": "Section B gives Watson as a case of broad distrust in a specific AI system.",
                "q29": "Section C explains psychological reasons people trust humans more than AI.",
                "q30": "Section D describes polarization and growing divergence in attitudes.",
                "q31": "Section E argues for transparency about algorithms and purposes.",
                "q32": "Section F highlights benefits when users can modify/influence AI behavior.",
                "q33": "Section A sets up the core problem: low trust in AI despite strong performance.",
                "q34": "Section C says AI is hard to comprehend, making interaction anxiety-inducing.",
                "q35": "It says AI failures get disproportionate media attention, driving mistrust.",
                "q36": "The experiment found watching AI films polarized participants' views.",
                "q37": "No claim is made that portrayals will become more positive specifically.",
                "q38": "Section D says rejecting AI advantages could put many people at a disadvantage.",
                "q39": "Section E says prior experience significantly improves opinions, the opposite of the statement.",
                "q40": "Section F reports higher satisfaction and adoption when users can slightly modify the algorithm."
            }
        }
    ]
};
