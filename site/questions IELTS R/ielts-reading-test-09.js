// IELTS Reading Test 09 - Generated 03/06/2026
...
window.IELTS_READING_TEST = {
    ...
    "passages": [
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        ...
                        {
                            "id": 2,
                            "text": "a reference to the various locations where high-rise wooden buildings can be found"
                        },
                        {
                            "id": 3,
                            "text": "an indication of how widely available the raw materials of concrete are"
                        },
                        {
                            "id": 4,
                            "text": "the belief that more high-rise wooden buildings are needed before wood can be regarded as a viable construction material"
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 5,
                            "text": "Wood is a traditional building material, but current environmental concerns are encouraging 5 {INPUT} to use wood in modern construction projects."
                        },
                        {
                            "id": 6,
                            "text": "Using wood, however, has its challenges. For example, as 6 {INPUT} in the atmosphere enters wood, it increases in size. In addition, wood is prone to pests and the risk of fire is greater."
                        },
                        {
                            "id": 7,
                            "text": "However, wood can be turned into a better construction material if it is treated and combined with other materials. In one process, 7 {INPUT} of solid wood are glued together to create building blocks."
                        },
                        {
                            "id": 8,
                            "text": "These blocks are lighter than concrete and steel but equal them in strength. Experts say that wooden buildings are an improvement on those made of concrete and steel in terms of the 8 {INPUT} with which they can be constructed and how much noise is generated by the process."
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        ...
                        {
                            "id": 13,
                            "text": "The environmental damage caused by concrete is due to it being produced in large quantities."
                        }
                    ]
                }
            ],
            ...
            "questionSections": [
                ...
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 24,
                            "text": "The Model E was road-tested in 1924 by the Automobile Club of America. They found it easy to drive, despite its weight, and it impressed the spectators. A later version of the Model E raised its 24 {INPUT} , while keeping its emissions extremely low."
                        },
                        {
                            "id": 25,
                            "text": "The steam car was too expensive for many people and its design was constantly being altered. Under 25 {INPUT} cars were produced before the company went out of business."
                        },
                        {
                            "id": 26,
        ...
        },
        {
            ...
            "shortName": "Mixed-Ability Classes",
            "difficulty": "Hard",
            "questionRange": "27-40",
            "timeRecommended": 20,
            "passageHeader": {
            ...
            "questionSections": [
                ...
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 31,
                            "text": "According to Professor John Hattie of the Melbourne Education Research Institute, there is very little indication that streaming leads to 31 {INPUT} ."
                        },
                        {
                            "id": 32,
                            "text": "He points out that, in schools which use streaming, the most significant impact is on those students placed in the 32 {INPUT} , especially where a large proportion of"
                        },
                        {
                            "id": 33,
                            "text": "them have 33 {INPUT} ."
                        },
                        {
                            "id": 34,
                            "text": "Meanwhile, for the 34 {INPUT} , there appears to be only minimal advantage."
                        },
                        {
                            "id": 35,
                            "text": "A further issue is that teachers tend to have 35 {INPUT} of students in streamed groups."
                        }
                    ]
                },
                {
