// IELTS Reading Test 02 - Generated 12/26/2025
    ...
    "passages": [
        {
            ...
            "shortName": "Industrial Revolution",
            "difficulty": "Easy",
            "questionRange": "1-13",
            "timeRecommended": 20,
            "passageHeader": {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 1,
                            "text": "<strong>Steam power</strong> • Newcomen's steam engine was used in mines to remove water. • In Watt and Boulton's steam engine, the movement of the {INPUT} was linked to a gear system."
                        },
                        {
                            "id": 2,
                            "text": "A greater supply of {INPUT} was required to power steam engines."
                        },
                        {
                            "id": 3,
                            "text": "<strong>Textile industry</strong> • Before the Industrial Revolution, spinners and weavers worked at home and in {INPUT} ."
                        },
                        {
                            "id": 4,
                            "text": "Not as much {INPUT} was needed to produce cloth once the spinning jenny and power loom were invented."
                        },
                        {
                            "id": 5,
                            "text": "<strong>Iron industry</strong> • Smelting of iron ore with coke resulted in material that was better {INPUT} ."
                        },
                        {
                            "id": 6,
                            "text": "Demand for iron increased with the growth of the {INPUT} ."
                        },
                        {
                            "id": 7,
                            "text": "<strong>Communications</strong> • Cooke and Wheatstone patented the first telegraphy system. • The telegraphy system was used to prevent locomotives colliding. <strong>Urbanisation</strong> • Small towns turned into cities very quickly. • The new cities were dirty, crowded and lacked sufficient {INPUT} ."
                        }
                    ]
                },
                {
            ...
            "questionSections": [
                ...
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 19,
                            "text": "Performance stress involves many demands on the athlete, for example, coping with the possible risk of {INPUT} ."
                        },
                        {
                            "id": 20,
                            "text": "Cortisol can cause tennis players to produce fewer good {INPUT} ."
                        },
                        {
                            "id": 21,
                            "text": "Psychologists can help athletes to view their physiological responses as the effect of a positive feeling such as {INPUT} ."
                        },
                        {
                            "id": 22,
                            "text": "{INPUT} is an example of a psychological technique which can reduce an athlete's stress responses."
                        }
                    ]
                },
                {
                    ...
                    "instruction": "Questions 23 and 24<br><br>Choose TWO letters, A–E.<br><br>Write the correct letters in boxes 23 and 24 on your answer sheet.<br><br>Which TWO facts about Emma Raducanu's withdrawal from the Wimbledon tournament are mentioned in the text?",
                    "headingsList": [],
                    "featuresList": [],
                    "questions": [
                        {
                ...
                },
                {
                    ...
                    "instruction": "Questions 25 and 26<br><br>Choose TWO letters, A–E.<br><br>Write the correct letters in boxes 25 and 26 on your answer sheet.<br><br>Which TWO facts about anxiety are mentioned in Paragraph E of the text?",
                    "headingsList": [],
                    "featuresList": [],
                    "questions": [
                        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 27,
                            "text": "Maryam Mirzakhani is regarded as {INPUT} in the field of mathematics because she was the only female holder of the prestigious Fields Medal – a record that she retained at the time of her death."
                        },
                        {
                            "id": 28,
                            "text": "However, maths held little {INPUT} for her as a child and in fact her performance was below average until she was"
                        },
                        {
                            "id": 29,
                            "text": "{INPUT} by a difficult puzzle that one of her siblings showed her."
                        },
                        {
                            "id": 30,
                            "text": "Later, as a professional mathematician, she had an inquiring mind and proved herself to be {INPUT} when things did not go smoothly."
                        },
                        {
                            "id": 31,
                            "text": "She said she got the greatest {INPUT} from making ground-breaking discoveries"
                        },
                        {
                            "id": 32,
                            "text": "and in fact she was responsible for some extremely {INPUT} mathematical studies."
                        }
                    ]
                },
                {
