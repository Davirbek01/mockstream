    ...
    "passages": [
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 1,
                            "text": "<strong>Dolls</strong><br><strong>Earliest known dolls</strong><br>represented religious figures<br>used as toys<br><strong>Egypt, 2000 BC</strong><br>bodies were made of wood<br>{INPUT} was used for the hair"
                        },
                        {
                            "id": 2,
                            "text": "<strong>Ancient Greece and Rome</strong><br>dolls were given to {INPUT} by older girls"
                        },
                        {
                            "id": 3,
                            "text": "<strong>600 BC</strong><br>realistic dolls had separate clothes and {INPUT} that could be put in different positions"
                        },
                        {
                            "id": 4,
                            "text": "<strong>17th and 18th centuries</strong><br>dolls made of {INPUT} became more common"
                        },
                        {
                            "id": 5,
                            "text": "moulds made of {INPUT}"
                        },
                        {
                            "id": 6,
                            "text": "<strong>1800s</strong><br>new manufacturing process developed<br>new group of mixtures known as {INPUT}<br>recipes for these mixtures kept secret"
                        }
                    ]
                },
                {
                    ...
                    "instruction": "Questions 7-13<br><br>Do the following statements agree with the information given in Reading Passage 1?<br><br>In boxes 7-13 on your answer sheet, write<br><br><strong>True</strong> if the statement agrees with the information<br><strong>False</strong> if the statement contradicts the information<br><strong>Not Given</strong> if there is no information on this",
                    "headingsList": [],
                    "featuresList": [],
                    "questions": [
                        {
                            "id": 7,
                            "text": "Bisque dolls appear less realistic than dolls made of china."
                        },
                        {
                            "id": 8,
                            "text": "French dolls tended to cost more than German bisque dolls."
                        },
                        {
                            "id": 9,
                            "text": "The first rag dolls were made in the 1850s."
                        },
                        {
                            "id": 10,
                            "text": "Only dolls made of cotton or linen are classified as cloth dolls."
                        },
                        {
                            "id": 11,
                            "text": "Dolls made of celluloid tended to lose their colour."
                        },
                        {
                            "id": 12,
                            "text": "Composition dolls lasted longer than the plastic dolls that were made in the 1940s."
                        },
                        {
                            "id": 13,
                            "text": "Doll collectors prefer a doll to be dressed in its original clothing."
                        }
                    ]
                }
            ],
            ...
            "explanations": {
                "q1": {
                    "text": "Paragraph B mentions that dolls constructed of flat pieces of wood were found in Egyptian graves dating back to 2000 BC, and that these dolls had 'hair' made of clay.",
                    "quote": "Dolls constructed of flat pieces of wood, painted with various designs, and with 'hair' made of clay, have often been found in Egyptian graves dating back to 2000 BC."
                },
                "q2": {
                    "text": "According to Paragraph C, girls from ancient Greece and Rome offered their wooden dolls to goddesses after they were too 'grown-up' to play with dolls.",
                    "quote": "Girls from ancient Greece and Rome offered their wooden dolls to goddesses after they were too 'grown-up' to play with dolls."
                },
                "q3": {
                    "text": "Paragraph C states that the ideal of making dolls as lifelike as possible led to the creation of dolls with movable limbs and removeable garments, dating back to 600 BC.",
                    "quote": "That ideal led to the creation of dolls with movable limbs and removeable garments, dating back to 600 BC."
                },
                "q4": {
                    "text": "Paragraph F indicates that in the 17th and 18th centuries, wax dolls grew in popularity.",
                    "quote": "In addition to wooden dolls, wax dolls grew in popularity in the 17th and 18th centuries."
                },
                "q5": {
                    "text": "Paragraph F explains the wax dollmaking process, stating that dollmakers would cover a doll's head with plaster to create a mould.",
                    "quote": "Wax dollmakers would model a doll's head in wax or clay, and then cover it with plaster to create a mould."
                },
                "q6": {
                    "text": "Paragraph E defines 'Composition' as mixtures of pulped wood or paper used to make doll heads and bodies, and mentions that manufacturers closely guarded the recipes for these mixtures.",
                    "quote": "'Composition' is a collective term for mixtures of pulped wood or paper that were used to make doll heads and bodies."
                },
                "q7": {
                    "text": "Paragraph G states that bisque looked more like skin than china did, implying that bisque dolls appear *more* realistic than china dolls.",
                    "quote": "Bisque, which is porcelain fired twice with colour added to it after the first firing, looked more like skin than china did."
                },
                "q8": {
                    "text": "Paragraph H mentions that although the French dolls were unrivalled in their artistry, German bisque dolls became quite popular because they were not as expensive.",
                    "quote": "Although the French dolls were unrivalled in their artistry, German bisque dolls became quite popular because they were not as expensive."
                },
                "q9": {
                    "text": "Paragraph I states that commercially produced rag dolls were first introduced in the 1850s, but also mentions that rag dolls were made by mothers for their children for many centuries before that.",
                    "quote": "For many centuries, rag dolls were made by mothers for their children."
                },
                "q10": {
                    "text": "Paragraph I defines 'cloth doll' as a subset of rag dolls made of linen or cotton.",
                    "quote": "'Cloth doll' refers to a subset of rag dolls made of linen or cotton."
                },
                "q11": {
                    "text": "Paragraph J indicates that celluloid fell out of favour because of its extreme flammability and propensity to fade in bright light.",
                    "quote": "However, celluloid fell out of favour because of its extreme flammability and propensity to fade in bright light."
                },
                "q12": {
                    "text": "Paragraph K states that hard plastic dolls were manufactured in the 1940s and that they resembled composition dolls, but they were much more durable.",
                    "quote": "Hard plastic dolls were manufactured in the 1940s. They resembled composition dolls, but they were much more durable."
                },
                "q13": {
                    "text": "The passage does not contain any information about doll collectors' preferences regarding original clothing.",
                    "quote": ""
                }
            }
        },
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 14,
                            "text": "a reference to studies involving children"
                        },
                        {
                            "id": 15,
                            "text": "a mention of the discovery of significant artefacts"
                        },
                        {
                            "id": 16,
                            "text": "reasons why a particular aspect of music has not been researched"
                        },
                        {
                            "id": 17,
                            "text": "a mention of an unexpected discovery involving two different areas of the brain"
                        },
                        {
                            "id": 18,
                            "text": "a comparison of tone variations produced by certain animals and humans"
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 19,
                            "text": "<strong>A study involving collaboration between researchers in Oxford and Montreal</strong><br>The participants in this study led by Dr Chen were chosen because they were not musicians, and they demonstrated a good state of {INPUT}."
                        },
                        {
                            "id": 20,
                            "text": "The participants were given {INPUT}, while music with a very noticeable rhythm was being played."
                        },
                        {
                            "id": 21,
                            "text": "Previous research had indicated that listening to this type of music seemed to be of assistance to some {INPUT} people."
                        },
                        {
                            "id": 22,
                            "text": "By listening to it, their {INPUT} ability had definitely got better. The findings of Dr Chen's study proved most informative."
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 23,
                            "text": "Research into the brain activity set off by music may help people with speech defects."
                        },
                        {
                            "id": 24,
                            "text": "It may be possible in time to improve a person's ability to recognise certain musical characteristics."
                        },
                        {
                            "id": 25,
                            "text": "The way listeners react to certain musical combinations may be similar to the way they react to other noises."
                        },
                        {
                            "id": 26,
                            "text": "When a person reacts positively to music, the same parts of the brain are stimulated as when certain animals react to a positive outcome."
                        }
                    ]
                }
            ],
            ...
            "explanations": {
                "q14": {
                    "text": "Paragraph D mentions that even three-year-olds have been shown to link music in a major mode to happy faces and minor modes to sad faces.",
                ...
                "q15": {
                    "text": "Paragraph B refers to the discovery of musical instruments played by Neanderthals at least 50,000 years ago.",
                ...
                "q16": {
                    "text": "Paragraph C explains that psychologists have avoided researching the emotionality of music due to an 'image problem' and the belief that our response to music is acquired, not innate.",
                    "quote": "\"For psychologists, who are always desperate to show that their work is rigorous, there's an image problem in tackling the emotionality of music,\" says Professor Norman Cook...Emotion is such a slippery topic.\""
                },
                "q17": {
                    "text": "Paragraph G describes Dr. Chen's study, which found that rhythms triggered activity in both the hearing and motor regions of the brain, which was unexpected.",
                    "quote": "Chen and her colleagues found the rhythms triggered activity in parts of the brain linked to hearing, but something even more surprising was that the rhythms also triggered activity in the motor regions of the brain, linked to active movement."
                },
                "q18": {
                    "text": "Paragraph E compares tone variations in music to emotional telltales in communication between mammals, including humans.",
                    "quote": "The same change in pitch works as an emotional telltale in communication between some mammals, where rising pitch is used to communicate weakness or defeat, while falling pitch signals social dominance."
                },
                "q19": {
                    "text": "Paragraph G states the volunteers were in first-rate physical health but musically untrained.",
                ...
                "q20": {
                    "text": "Paragraph G mentions that brain scans were carried out on volunteers.",
                ...
                "q21": {
                    "text": "Paragraph G mentions that studies involving patients with movement difficulties were conducted.",
                    "quote": "Her interest was sparked by studies involving patients with movement difficulties."
                },
                "q22": {
                    "text": "Paragraph G states that music with a strong rhythm helped patients improve their walking ability.",
                ...
                "q23": {
                    "text": "Paragraph H suggests that the connection between music and movement may help with impairments such as those involved in sound production.",
                    "quote": "\"It's been shown that people who talk with a stutter might have problems in this auditory-motor loop.\""
                },
                "q24": {
                    "text": "Paragraph I mentions that training could enhance the ability to identify slight changes in a melody.",
                    "quote": "\"This ability could be enhanced by training - just like someone born with a predisposition to building strong muscles can enhance them by taking up weightlifting.\""
                },
                "q25": {
                    "text": "Paragraph E suggests that the way people respond to notes is linked to how our brains interpret certain sounds in everyday life.",
                ...
                "q26": {
                    "text": "Paragraph F states that pleasurable music activates brain circuitry associated with biological rewards, like food, which we share with other animals.",
                    "quote": "The biggest surprise was the evidence that pleasurable music activates brain circuitry which has been in existence in the human brain for thousands of years says Zatorre. We share it with rats and other distant relatives on the evolutionary tree - and it's typically associated with biological rewards, like food, for example."
                }
            }
        },
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 27,
                            "text": "Through his observations of yawns, Provine was able to confirm that {INPUT} do not exist."
                        },
                        {
                            "id": 28,
                            "text": "Just like a {INPUT}, yawns cannot be interrupted after they have begun."
                        },
                        {
                            "id": 29,
                            "text": "This is because yawns occur as a {INPUT} rather than a stimulus response as was previously thought."
                        },
                        {
                            "id": 30,
                            "text": "In measuring the time taken to yawn, Provine found that a typical yawn lasts about {INPUT}."
                        },
                        {
                            "id": 31,
                            "text": "He also found that it is common for people to yawn a number of times in quick succession with the yawns usually being around {INPUT} apart."
                        },
                        {
                            "id": 32,
                            "text": "When studying whether length and rate were connected, Provine concluded that {INPUT} do not necessarily produce more yawns to make up for this."
                        }
                    ]
                },
                {
            ...
            "explanations": {
                "q27": {
                    "text": "The passage states, \"There are no half-yawns: this is an example of the typical intensity of fixed action patterns and a reason why you cannot stifle yawns.\"",
                    "quote": "There are no half-yawns"
                },
                "q28": {
                    "text": "The passage compares a yawn to a cough, stating that once started, it progresses with inevitability.",
                    "quote": "Just like a cough, yawns can come in bouts"
                },
                "q29": {
                    "text": "The passage describes a yawn as an instinctive 'fixed action pattern' rather than a reflex.",
                    "quote": "It is an excellent example of the instinctive 'fixed action pattern'"
                },
                "q30": {
                    "text": "The passage mentions that the standard yawn runs its course over about six seconds on average.",
                    "quote": "The standard yawn runs its course over about six seconds on average"
                },
                "q31": {
                    "text": "The passage indicates that yawns can come in bouts with a highly variable inter-yawn interval, which is generally about 68 seconds.",
                    "quote": "generally about 68 seconds"
                },
                "q32": {
                    "text": "The passage states that there is no relation between yawn frequency and duration; producers of short or long yawns do not compensate by yawning more or less often.",
                    "quote": "producers of short or long yawns do not compensate by yawning more or less often"
                },
                "q33": {
                    "text": "The closed nose yawn experiment showed that the mouth provides a sufficient airway, indicating you can yawn without breathing through your nose.",
                    "quote": "the mouth provides a sufficient airway"
                },
                "q34": {
                    "text": "The clenched teeth yawn experiment demonstrates that gaping of the jaws is an essential component of the yawn, meaning you have to be able to open your mouth wide to yawn.",
                    "quote": "gaping of the jaws is an essential component of the fixed pattern of the yawn"
                },
                "q35": {
                    "text": "The nose yawn experiment tested the adequacy of the nasal airway to sustain a yawn, concluding that yawning cannot be accomplished only through the nose.",
                    "quote": "yawning is impossible via nasal inhalation alone"
                },
                "q36": {
                    "text": "The passage notes that in people paralyzed on one side, yawning can activate undamaged connections, causing movement in the paralyzed arm.",
                    "quote": "their otherwise paralyzed arm rises and flexes automatically"
                },
                "q37": {
                    "text": "The writer concludes that yawning is a reminder that ancient and unconscious behavior linking us to the animal world lurks beneath the veneer of culture, rationality, and language.",
                    "quote": "ancient and unconscious behavior linking us to the animal world lurks beneath the veneer of culture, rationality, and language"
                },
                "q38": {
                    "text": "The passage mentions that it was difficult for Provine to convince research students of the merits of 'yawning science'.",
                    "quote": "it was difficult for him to convince research students of the merits of 'yawning science'"
                },
                "q39": {
                    "text": "The passage mentions foetuses yawning and stretching, but does not state that they are learning how to control movement.",
                    "quote": ""
                },
                "q40": {
                    "text": "Provine speculated that yawning may have many functions, and selecting a single function may be unrealistic.",
                    "quote": "selecting a single function from the available options may be an unrealistic goal"
                }
            }
        }
    ]
