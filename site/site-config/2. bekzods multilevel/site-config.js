// ============================================================================
// SITE CONFIG — Bekzods Multilevel
// ============================================================================
// Single source of truth for all branding, URLs, and identity settings.
// Load this file via <script src="site config/bekzods multilevel/site-config.js">
...
window.SITE_CONFIG = {
  ...
  // ─── PWA / Clone folder ─────────────────────────────────────────────────────
  pwaFolder:        'site-config/2. bekzods multilevel',

  // ─── Brand Identity ────────────────────────────────────────────────────────
  brandName:        'Bekzods Multilevel',
  testIdentifier:   'bek',
  logoUrl:          'https://storage.googleapis.com/mockstream-listening-audio/LOGOS/BEK.png',
  heading1:         'Men sizni C1 olish darajasida tayyorlayman',
  heading2:         "Bekzod Turg'unov",

  // ─── Telegram ──────────────────────────────────────────────────────────────
  telegramChannel:      '@bekzodsmultilevel',
  telegramUrl:          'https://t.me/bekzodsmultilevel',
  ieltsTelegramChannel: '@bekzodsmultilevel',
  adminTelegram:        'https://t.me/mrkhasanoff3',

  // ─── Certificate / PDF ─────────────────────────────────────────────────────
  directorName:     'B. TURGUNOV',
  directorFullName: "Bekzod Turg'unov",
  directorTitle:    'Direktor | Director',
  ceoTitle:         'CEO of Bekzods Multilevel',
