    ...
    "parts": [
        {
            ...
            "questions": [
                {
                    "id": 1,
                    "hint": "These _____ are just guesses"
                },
                {
                    "id": 2,
                    "hint": "The _____ examined a rare fossil"
                },
                {
                    "id": 3,
                    "hint": "The _____ is 78 million years old"
                },
                {
                    "id": 4,
                    "hint": "creature's _____ box"
                },
                {
                    "id": 5,
                    "hint": "The _____ controlled the sounds"
                },
                {
                    "id": 6,
                    "hint": "change its scary roars to a _____ sound"
                }
            ],
            "answers": {
                "1": [
            ...
            "explanations": {
                "q1": {
                    "text": "The sentence directly states that 'these' are 'just guesses', and the only word that logically fits and is present in the text is 'noises'. The passage discusses dinosaur sounds, making 'noises' the appropriate term for what directors are guessing about.",
                    "quote": "However, these _____(1)_____ are just guesses that movie directors make."
                },
                "q2": {
                    "text": "The sentence directly states that the 'scientists' performed the examination. The passage discusses a scientific discovery, making 'scientists' the logical subject performing the examination of the fossil.",
                    "quote": "The scientists examined a rare fossil from a dinosaur called an ankylosaur."
                },
                "q3": {
                    "text": "The sentence directly states that 'The fossil is 78 million years old,' making 'fossil' the correct word to fill the gap. The age of 78 million years provides context that it must be a very old object, like a fossil.",
                    "quote": "The fossil is 78 million years old."
                },
                "q4": {
                    "text": "The question asks what kind of box the creature had, and the sentence states that the shape of the creature's 'voice' box suggests it made bird-like sounds, indicating 'voice' is the missing word.",
                    "quote": "The scientists think the shape of the creature's _____(4)_____ box means it probably made bird-like sounds."
                },
                "q5": {
                    "text": "The sentence directly states that the 'muscles' controlled the sounds of the voice box, making it the correct answer. The surrounding context discusses the voice box and how it functions to produce sound.",
                    "quote": "The muscles controlled the sounds of the voice box."
                },
                "q6": {
                    "text": "The sentence directly states that scary roars may need to change to a \"tweeting\" sound, indicating that 'tweeting' is the correct word to fill the gap. This aligns with the passage's overall argument that dinosaurs likely made bird-like sounds.",
                    "quote": "Hollywood may have to change its scary roars in future dinosaur films to a tweeting sound."
                }
            }
        },
        {
            ...
            "statements": [
                {
                    "letter": "A",
                    "text": "Visitor can help to make one particular event a success at this festival."
                },
                {
                    "letter": "B",
                    "text": "People can listen to local musicians here."
                },
                {
                    "letter": "C",
                    "text": "At this festival, people can listen to music in lots of different places."
                },
                {
                    "letter": "D",
                    "text": "It is not necessary to pay for one of the events here."
                },
                {
                    "letter": "E",
                    "text": "It is possible to stay overnight at this festival."
                },
                {
                    "letter": "F",
                    "text": "Visitors can get advice here."
                },
                {
                    "letter": "G",
                    "text": "People can watch craftspeople at work here."
                },
                {
                    "letter": "H",
                    "text": "Learning what all the different sections of a plant do."
                },
                {
                    "letter": "I",
                    "text": "Seeing art showing plants from a different part of the world."
                },
                {
                    "letter": "J",
                    "text": "The possibility of having your work exhibited."
                }
            ],
            "texts": [
                {
                ...
                {
                    "number": 10,
                    "content": "Rightly nominated for the best family festival award every year since it began in 2005, this festival offers a combination of different music genresвЂ”many featuring artists from around the Wychwood areaвЂ”and comedy, alongside a selection of outdoor cafes serving amazing world foods."
                },
                {
                    "number": 11,
            ...
            "explanations": {
                "q7": {
                    "text": "The phrase 'free music' indicates that attendees do not need to pay for at least one of the events at the festival. Therefore, it matches statement D.",
                    "quote": "Starting with a great night of free music, 'Party in the city' this year is going to be no exception."
                },
                "q8": {
                    "text": "The phrase \"30-plus venues\" directly implies that music can be heard in many different places at this festival, supporting statement C.",
                    "quote": "more than 300 bands will perform to around 10,000 people in 30-plus venues"
                },
                "q9": {
                    "text": "The phrase \"wood carving demonstrations\" directly indicates that people can observe craftspeople creating wood carvings, thus matching statement G.",
                    "quote": "with sheep herding, wood carving demonstrations, insect hunts and more activities, accompanied by live music and a great farmers' market, offering all sorts of mouth-watering produce."
                },
                "q10": {
                    "text": "The phrase \"artists from around the Wychwood area\" indicates that local musicians perform at the festival. Therefore, people can listen to local musicians here.",
                    "quote": "this festival offers a combination of different music genresвЂ”many featuring artists from around the Wychwood area"
                },
                "q11": {
                    "text": "While not explicitly stating visitors 'help', the festival's aim to educate through sampling implies active participation, contributing to the event's success by engaging with the produce and learning about its origin and production.",
                    "quote": "Bringing together a selection of the finest produce, this festival aims to educate visitors about how food should be produced and where it should come from, through sampling a range of tasty treats, cooked on site."
                },
                "q12": {
                    "text": "This sentence directly states that visitors have the option of staying overnight with local residents, implying that staying overnight at the festival is possible.",
                    "quote": "If you don't fancy taking a tent, some local residents usually offer to put visitors up."
                },
                "q13": {
                    "text": "The phrase \"everyone is invited to join in\" directly implies that visitors can participate in and contribute to the success of the world record attempt, thus supporting statement A.",
                    "quote": "including a world record attempt, where everyone is invited to join in."
                },
                "q14": {
                    "text": "The text describes an exhibition of paintings of South American plants, which directly corresponds to seeing art showing plants from a different part of the world. The paintings depict plants from South America, making it a different part of the world.",
                    "quote": "Visit our exciting and colourful exhibition of South American botanical paintings, which brings the continent's exotic and lush plants to life in works from two hundred years ago and from this century."
                }
            }
        },
        {
            ...
            "headings": [
                ...
                {
                    "letter": "C",
                    "text": "Rose family traits"
                },
                {
                    "letter": "D",
                    "text": "Discovering origins"
                },
                {
                    "letter": "E",
                    "text": "Many choices"
                ...
                {
                    "letter": "F",
                    "text": "A flower of luxury"
                },
                {
                    "letter": "G",
                    "text": "A flower of conflict"
                },
                {
                    "letter": "H",
                    "text": "A symbol for all times"
                }
            ],
            "passage": {
            ...
            "explanations": {
                "q15": {
                    "text": "This sentence indicates the rose's enduring presence and significance across various aspects of human civilization, suggesting it's a symbol that has resonated throughout history and continues to do so.",
                    "quote": "The rose is the most deeply ingrained flower in human history and human culture."
                },
                "q16": {
                    "text": "This sentence explicitly states a trait of the rose family, highlighting its relationship to other fruits. The paragraph also discusses other characteristics common to rose species, such as their distribution and blooming habits.",
                    "quote": "All roses are close relatives of cherries, apples, pears, raspberries, and plums."
                },
                "q17": {
                    "text": "This sentence demonstrates how roses were a luxury item for the wealthy, even at the expense of the common people. The elite's demand for rose products caused hardship, highlighting the flower's status as a luxury.",
                    "quote": "Perfumes made from roses became a high-priority treasure for the ruling elite, and it resulted in hardships among the peasant class, who were forced to grow roses instead of cultivating much needed food."
                },
                "q18": {
                    "text": "The paragraph discusses the War of the Roses, where the rose symbolized the conflict between the House of York and the House of Lancaster, making \"A flower of conflict\" an appropriate heading.",
                    "quote": "During the 15th century in England, the rose became the symbol of war between two families, both of whom had laid claim to the English crown."
                },
                "q19": {
                    "text": "This sentence directly states that roses and rose water were used as currency, which clearly supports the idea of roses being 'beautiful money'. The paragraph goes on to describe how roses were used for bartering and paying taxes.",
                    "quote": "In the 17th century, the rose became so valuable across Europe that it along with rose water was often used as currency."
                },
                "q20": {
                    "text": "The paragraph discusses the search for the origins of roses, mentioning fossil records and possible cultivation in ancient China and Mesopotamia. The heading \"Discovering origins\" accurately reflects this focus on the historical beginnings of roses.",
                    "quote": "Where, exactly, first roses appeared is still unknown."
                }
            }
        },
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 21,
                            "text": "Hillary was a bright learner at school who вЂ¦вЂ¦",
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "was busy with trade"
                                },
                                {
                                    "letter": "B",
                                    "text": "had good handwriting skills"
                                },
                                {
                                    "letter": "C",
                                    "text": "was always busy with social interactions"
                                },
                                {
                                    "letter": "D",
                                    "text": "had few friends and reserved"
                                }
                            ]
                        },
                        {
                            "id": 22,
                            "text": "She was a fairly chubby young womanвЂ¦вЂ¦",
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "wearing oversized glasses and formless clothing"
                                },
                                {
                                    "letter": "B",
                                    "text": "with reserved character"
                                },
                                {
                                    "letter": "C",
                                    "text": "with classical output and hat"
                                },
                                {
                                    "letter": "D",
                                    "text": "with looking smart lady"
                                }
                            ]
                        },
                        {
                            "id": 23,
                            "text": "Bill had returned to his native Arkansas at the time with plansвЂ¦.",
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "to finance his deputy"
                                },
                                {
                                    "letter": "B",
                                    "text": "to collaborate with native land"
                                },
                                {
                                    "letter": "C",
                                    "text": "to pursue a career in politics"
                                },
                                {
                                    "letter": "D",
                                    "text": "to start his new life"
                                }
                            ]
                        },
                        {
                            "id": 24,
                            "text": "A program specialized for school medical services was implemented by вЂ¦.",
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "Bill Clinton"
                                ...
                                {
                                    "letter": "C",
                                    "text": "a group of lawyers"
                                },
                                {
                                    "letter": "D",
                                    "text": "the governor of Arkansas"
                                }
                            ]
                        }
                    ]
            ...
            "answers": {
                ...
                "22": [
                    "A",
                    "wearing oversized glasses and formless clothing"
                ],
                "23": [
                    "C",
            ...
            "explanations": {
                "q21": {
                    "text": "The passage states Hillary spent a lot of time on outside activities, which implies she was busy with social interactions, making option C the correct answer.",
                    "quote": "On the contrary, she spent a lot of time on outside activities, something which is always greatly appreciated in American schools."
                },
                "q22": {
                    "text": "The passage states that photos showed her as a \"fairly plump young woman, dressed in rather shapeless clothes, and wearing large glasses,\" which directly supports option A.",
                    "quote": "Photos taken at the time show her as a fairly plump young woman, dressed in rather shapeless clothes, and wearing large glasses."
                },
                "q23": {
                    "text": "The passage states that Bill returned to Arkansas \"intending to follow a career in politics,\" which directly supports option C.",
                    "quote": "Meanwhile, while Bill had gone back to his native Arkansas, intending to follow a career in politics, Hillary became a brilliant lawyer in Washington, where she took part in the famous Watergate hearings."
                },
                "q24": {
                    "text": "The passage states that Hillary helped Bill establish a school medical welfare system, implying that she was instrumental in implementing the program.",
                    "quote": "During Bill's twelve years in office as Governor of Arkansas, Hillary helped him to radically reform the state's public-school system, and establish a school medical welfare system that had no equivalent anywhere else in the United States."
                },
                "q25": {
                    "text": "The passage states that Hillary was actively involved in the Women's Liberation movement. While the passage doesn't explicitly mention Bill's involvement, Hillary's active participation confirms their contribution to the movement.",
                    "quote": "At the time, Hillary was actively involved in the Women's Liberation movement, and seemed to be much more interested in her career than in marriage."
                },
                "q26": {
                    "text": "The passage states that Chelsea was named after a favorite hit song of the 1960s, which directly supports the statement that Chelsea got her name from a popular 1960s hit song.",
                    "quote": "A year later, Hillary gave birth to their daughter Chelsea, named after a favorite hit song of the 1960's."
                },
                "q27": {
                    "text": "The passage states that Bill Clinton was elected governor and became the youngest state governor, contradicting the question's claim that he rejected the position.",
                    "quote": "In 1979, at the age of 32, Bill Clinton was elected Governor of Arkansas, becoming the youngest state Governor in the U.S.A."
                },
                "q28": {
                    "text": "The passage states that Hillary met Bill Clinton at Yale Law School, not at the Students' Union, therefore the statement is false.",
                    "quote": "It was at Yale Law School that Hillary first met Bill Clinton"
                },
                "q29": {
                    "text": "The passage mentions Hillary being elected President of the Students' Union, but it does not provide any information about scholarships or recognizing distinguished individuals in any field.",
                    "quote": ""
                }
            }
        },
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 30,
                            "hint": "horses were trained by _____"
                        },
                        {
                            "id": 31,
                            "hint": "all around the continent except _____"
                        },
                        {
                            "id": 32,
                            "hint": "not wearing their _____ hats"
                        },
                        {
                            "id": 33,
                            "hint": "rope calf with a _____"
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        {
                            "id": 34,
                            "text": "Katie Sharpe, who was the local Rodeo Queen, demonstrated her talents by acting all types of rodeo apart from вЂ¦.",
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "calf roping"
                                ...
                                {
                                    "letter": "B",
                                    "text": "saddle-bronc riding"
                                },
                                {
                                    "letter": "C",
                                    "text": "triangular shaped race-course"
                                },
                                {
                                    "letter": "D",
                                    "text": "dexterity on the backs"
                                }
                            ]
                        },
                        {
            ...
            "explanations": {
                "q30": {
                    "text": "The passage states that 'a handful of cowboys impeccably trained horses,' which directly answers who trained the horses.",
                    "quote": "Microlight kids on minuscule ponies are cavorting round the empty arena, while a handful of cowboys impeccably trained horses, walk or trot sedately round the ring."
                },
                "q31": {
                    "text": "The passage states that most of the people around the narrator are from specific towns and \"certainly not from Europe!\", indicating that the rodeo is a local event and not attended by people from all around the continent except Europe.",
                    "quote": "Not this one; in central Oregon, there are few tourists.\nRodeos here are for the locals, people who know them and understand them; most of the folk round me are from Redmond, or Prineville or Madras or Bend, certainly not from Europe!"
                },
                "q32": {
                    "text": "The passage states that the men take off their Stetson hats, so the answer is Stetson.",
                    "quote": "the men take off their Stetson hats"
                },
                "q33": {
                    "text": "The passage states that calf roping involves catching a calf with a lasso, which directly answers the question.",
                    "quote": "While some show their skills at calf roping вЂ” catching a running calf with a lasso and tying it up in just a few seconds вЂ” others demonstrate their daredevil skills by riding untamed broncos or bounding round on the backs of enormous raging bulls."
                },
                "q34": {
                    "text": "The passage states that Katie Sharpe participates in ladies' events, and these events include barrel racing on a triangular shaped race-course, but women do not compete in events like saddle-bronc riding.",
                    "quote": "Katie Sharpe, 21, the local Rodeo Queen, does a lap of honor, then participates in the ladies' events; but in this macho part of the world, the ladies do not get to pit themselves against untamed bulls and broncos!"
                },
                "q35": {
                    "text": "The passage states that the crowd laughs as the clown distracts the raging animals when riders fail with wild mounts, indicating that clowns appear during these failures.",
                    "quote": "then burst into laughter as the obligatory clown, the matador of the rodeo, distracts the attention of the raging animals while mounted cowboys round them up and calm them down, coaxing them away into the pens from which they originally emerged, their day's work finished."
                }
            }
        }
    ]
