    ...
    "parts": [
        {
            ...
            "questions": [
                {
                    "id": 1,
                    "hint": "The tradition comes from the _____ people"
                },
                {
                    "id": 2,
                    "hint": "invited the Native Americans for a _____"
                },
                {
                    "id": 3,
                    "hint": "the first Thanksgiving that people _____"
                },
                {
                    "id": 4,
                    "hint": "Nowadays, _____ is the country's largest"
                },
                {
                    "id": 5,
                    "hint": "to go with the huge roast _____"
                },
                {
                    "id": 6,
                    "hint": "There is usually one _____ in the afternoon"
                }
            ],
            "answers": {
                "1": [
        ...
        },
        {
            ...
            "headings": [
                {
                    "letter": "A",
                    "text": "Overcoming problems is part of the challenge of sailing"
                },
                {
                    "letter": "B",
                    "text": "Sailing tends to run in families"
                },
                {
                    "letter": "C",
                    "text": "Enthusiasm about sailing was infectious"
                },
                {
                    "letter": "D",
                    "text": "There's no hiding these sailors' ambitions"
                },
                {
                    "letter": "E",
                    "text": "There's always more you can learn about sailing"
                },
                {
                    "letter": "F",
                    "text": "Some basics about sailing were explained"
                },
                {
                    "letter": "G",
                    "text": "Sailors are used to waiting around"
                },
                {
                    "letter": "H",
                    "text": "These sailors have other talents"
                }
            ],
            "passage": {
                "title": "Rock the Boat",
                    ...
                    "questions": [
                        {
                            ...
                            "options": [
                                ...
                                {
                                    "letter": "B",
                                    "text": "patients at a clinic"
                                },
                                {
                                    "letter": "C",
                                    "text": "neurotic people"
                                },
                                {
                                    "letter": "D",
                                    "text": "health workers outside psychology"
                                }
                            ]
                        },
                        {
                            ...
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "They consider it their duty to treat all patients equally."
                                },
                                {
                                    "letter": "B",
                                    "text": "They think the effect on a patient's health will be hardly noticeable."
                                },
                                {
                                    "letter": "C",
                                    "text": "They lack sufficient training in psychology."
                                },
                                {
                                    "letter": "D",
                                    "text": "They doubt whether a person's personality directly affects their health."
                                }
                            ]
                        },
                        {
                            ...
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "They are at greater risk from early death than non-neurotic patients."
                                },
                                {
                                    "letter": "B",
                                    "text": "There is no consistent link between a patient's level of neurosis and their health."
                                },
                                {
                                    "letter": "C",
                                    "text": "Their neurosis protects them from becoming sick."
                                },
                                {
                                    "letter": "D",
                                    "text": "They are more likely than non-neurotic patients to report illness."
                                }
                            ]
                        },
                        {
                            ...
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "used drama and energy in its design."
                                },
                                {
                                    "letter": "B",
                                    "text": "failed to reduce cannabis use among teenagers."
                                },
                                {
                                    "letter": "C",
                                    "text": "was designed to attract conscientious, high sensation-seeking teenagers."
                                },
                                {
                                    "letter": "D",
                                    "text": "was delivered across multiple media, including television and online."
                                }
                            ]
                        }
                    ]
        ...
        },
        {
            ...
            "questionSections": [
                {
                    ...
                    "questions": [
                        {
                            "id": 30,
                            "hint": "waste which is generated in the _____ cells"
                        },
                        {
                            "id": 31,
                            "hint": "not surprising to observe an _____"
                        },
                        {
                            "id": 32,
                            "hint": "converting the cells into an _____"
                        },
                        {
                            "id": 33,
                            "hint": "Apart from the mouse, _____ were also applied"
                        }
                    ]
                },
                {
                    ...
                    "questions": [
                        {
                            ...
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "the waste handling mechanisms of the cells."
                                },
                                {
                                    "letter": "B",
                                    "text": "the continuous reproduction of cells."
                                },
                                {
                                    "letter": "C",
                                    "text": "called plutons."
                                ...
                                {
                                    "letter": "D",
                                    "text": "the importance of keeping the body busy."
                                }
                            ]
                        },
                        {
                            ...
                            "options": [
                                {
                                    "letter": "A",
                                    "text": "the process takes a long time."
                                },
                                {
                                    "letter": "B",
                                    "text": "the process is difficult."
                                },
                                {
                                    "letter": "C",
                                    "text": "it is bound to happen."
                                },
                                {
                                    "letter": "D",
                                    "text": "plutons cause damage before they are handled."
                                }
                            ]
                        }
                    ]
            ...
            "answers": {
                ...
                "34": [
                    "D",
                    "the importance of keeping the body busy."
                ],
                "35": [
                    "B",
